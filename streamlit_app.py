...
def main():
    ...
    if st.session_state.funds_list:
        ...
        # Welcome screen
        st.info("""
        ### Welcome to Conifer's Portfolio Analyzer!

        Search for stocks and mutual funds in the sidebar to build your portfolio. Then analyze your Portfolio and get a simulated view into its future! This is not a prediction but a mere simulation based on historical data.
        """)
    # Footer
    st.markdown("---")
    st.markdown("""
